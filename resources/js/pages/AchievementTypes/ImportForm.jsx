...
export default function ImportAchievementTypeForm({ auth }) {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Impor Jenis Prestasi</h2>}
    >
      <Head title="Impor Jenis Prestasi" />

      <Container>
        <Card title="Form Impor Jenis Prestasi">
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            <FormGroup
              label="Pilih File (Excel/CSV)"
              error={errors.import_file || pageErrors.import_file}
            >
              <input
                type="file"
                id="import_file"
