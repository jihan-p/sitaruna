...
export default function CreateAchievementType({ auth }) {
  ...
  const handleSubmit = (e) => {
    ...
    post(route(`${resource}.store`), {
      onSuccess: () => {
        reset();
        setTanggalBerlaku(null);
        setTanggalAkhirBerlaku(null);
      },
    });
  };
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Tambah Jenis Prestasi</h2>}
    >
      <Head title="Tambah Jenis Prestasi" />

      <Container>
        <Card title="Form Tambah Jenis Prestasi">
